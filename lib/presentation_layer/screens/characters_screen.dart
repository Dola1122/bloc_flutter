...
class _CharactersScreenState extends State<CharactersScreen> {
  ...
  late List<Character> searchList;
  ...
  Widget _buildSearchField() {
    return TextField(
      ...
      onChanged: (searchedCharacter) {
        addToSearchList(searchedCharacter);
      },
    );
  }

  void addToSearchList(searchedCharacter) {
  ...
  List<Widget> _buildAppBarActions() {
    if (_isSearching) {
      ...
      return [
        IconButton(onPressed: _startSearching, icon: Icon(Icons.search)),
      ];
    }
  }
  ...
  Widget buildNoInternetWidget(){
    return Center(child: Text("Can't connect .. check Internet "),);
  }
